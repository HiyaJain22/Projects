...
data = pd.read_table(r'C:/Users/hjain/Downloads/SMSSpamCollection.txt', sep='\t', names=["label", "message"])
...
def predict():
    message = request.form.get('msg') # Assuming the input field name in your form is 'rate'
